    ...
    def get_dynamic_threshold(self, original_text: str, processed_text: str) -> float:
        ...
        if len(words) == 1:
            ...
            if words[0] in positive_words:
                return 0.2  # Much lower threshold for single positive words
            elif words[0] in negative_words:
                return 0.7  # Higher threshold for single negative words
        
        # Multi-word positive cases - check for positive indicators
        positive_indicators = ['amazing', 'fantastic', 'excellent', 'wonderful', 'great', 'love', 'perfect', 'best', 'good']
        negative_indicators = ['terrible', 'awful', 'horrible', 'bad', 'hate', 'poor', 'worst', 'disappointing']
        ...
        if has_positive and not has_negative:
            return 0.2  # Much lower threshold for clearly positive text
        elif has_negative and not has_positive:
            return 0.6  # Higher threshold for clearly negative text
        elif has_positive and has_negative:
            return 0.4  # Mixed sentiment, use moderate threshold
        
        # Default threshold for neutral texts
        return 0.5
